...
# Finding best hyperparameters for classification task on Mammographic Mass Dataset
...
model1 = GridSearchCV(estimator=LogisticRegression(), param_grid=param_grid1,scoring='accuracy', refit=True, n_jobs=-1, verbose=3, cv= 10)
model1.fit(X, y)
print('Best config for Logistic Regression: %s' % model1.best_params_)
print("------------------------------------------------------------------------------------------")
print("Fitting model2...RF")
model2 = GridSearchCV(estimator=RandomForestClassifier(), param_grid=param_grid2, scoring='accuracy', refit=True, n_jobs=-1, verbose=3, cv= 10)
model2.fit(X, y)
print('Best config for Random Forest: %s' % model2.best_params_)
print("------------------------------------------------------------------------------------------")
print("Fitting model2...ANN")
model3 = GridSearchCV(estimator=KerasClassifier(build_fn=create_ANN_model, verbose=0), param_grid=param_grid3, n_jobs=-1,scoring='accuracy', verbose=3, cv= 10)
model3.fit(X, y)
print('Best config for ANN: %s' % model3.best_params_)
print("------------------------------------------------------------------------------------------")
print("Fitting model4...CART")
model4 = GridSearchCV(estimator=DecisionTreeClassifier(), param_grid=param_grid4, scoring='accuracy', refit=True, n_jobs=-1, verbose=3, cv= 10)
model4.fit(X, y)
print('Best config for Decision Trees: %s' % model4.best_params_)
print("------------------------------------------------------------------------------------------")
print("Fitting model5...NB")
model5 = GridSearchCV(estimator=GaussianNB(), param_grid=param_grid5,scoring='accuracy', refit=True, verbose=3, n_jobs=-1, cv= 10)
model5.fit(X, y)
print('Best config for Naive Bayes: %s' % model5.best_params_)
print("------------------------------------------------------------------------------------------")
print("Fitting model6...KNN")
model6 = GridSearchCV(estimator=KNeighborsClassifier(), param_grid=param_grid6, scoring='accuracy', refit=True, verbose=3, n_jobs=-1, cv= 10)
model6.fit(X, y)
print('Best config for KNN: %s' % model6.best_params_)
print("------------------------------------------------------------------------------------------")
print("Fitting model7...SVC")
model7 = GridSearchCV(estimator=SVC(), param_grid=param_grid7, scoring='accuracy', refit=True, verbose=3, n_jobs=-1, cv= 10)
model7.fit(X, y)
